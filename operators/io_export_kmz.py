...
class EXPORTGIS_OT_kmz_file(Operator, ExportHelper):
    ...
    def execute(self, context):
        ...
        zf = zipfile.ZipFile(self.filepath, mode='w')
        try:
            zf.write(kml_doc, 'doc.kml')
        except:
...
def register():
	bpy.utils.register_class(EXPORTGIS_OT_kmz_file)

def unregister():
	bpy.utils.unregister_class(EXPORTGIS_OT_kmz_file)
